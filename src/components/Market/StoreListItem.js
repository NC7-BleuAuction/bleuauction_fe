  ...
  return (
    <div className={styles.storeListItemBox}>
      {store.storeAttaches && store.storeAttaches[0] ? (
        <img
          className={styles.storeListItemBoss}
      ...
      <div className={styles.storeListItemDetailTop}>
        <div className={styles.storeListItemHeader}>
          <strong className={styles.storeListItemDetailName}>
            {store.storeName}
          </strong>
          <span className={styles.storeListItemDetailMarket}>
            {store.marketName}
          </span>
          <span className={styles.storeListItemDetailIntroduce}>
            {store.storeAddr}
          </span>
        </div>

        <p className={styles.storeListItemBoxReview}>
          <img className={styles.storeListItemFresh} src="/images/fresh.png" />
          5.0 (1024)
        </p>
        <p className={styles.storeListItemBoxState}>
          <img
            className={styles.storeListItemStateIcon}
        ...
        <div className={styles.storeListItemDetailBoxMore}>
          <Link to="/market/detail" state={store}>
            더보기&gt;
          </Link>
        </div>
      </div>
